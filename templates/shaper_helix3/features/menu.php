...
class Helix3FeatureMenu {
	...
	public function renderFeature()
	{
		...
		<?php } else if ($menu_type == 'mega') { ?>
			<div class='sp-megamenu-wrapper'>
				<a id="offcanvas-toggler" class="visible-sm visible-xs" aria-label="<?php echo Text::_('HELIX_MENU'); ?>" href="#"><i class="fa fa-bars" aria-hidden="true" title="<?php echo Text::_('HELIX_MENU'); ?>"></i></a>
				<?php $this->helix3->loadMegaMenu('hidden-sm hidden-xs'); ?>
			</div>
		<?php } else { ?>
