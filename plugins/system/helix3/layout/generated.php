  ...
  <div class="sp-modal-dialog">
    <div class="sp-modal-content">
      ...
      <div class="sp-modal-footer clearfix">
        <a href="javascript:void(0)" class="sppb-btn sppb-btn-success pull-left" id="save-settings" data-dismiss="spmodal"><?php echo Text::_('HELIX_APPLY'); ?></a>
        <button class="sppb-btn sppb-btn-danger pull-left" data-dismiss="spmodal" aria-hidden="true"><?php echo Text::_('HELIX_CANCEL'); ?></button>
      </div>
    </div>
  </div>
</div>
