...
$day 				= trim($comingsoon_date[0]);
$month 				= trim($comingsoon_date[1]);
$year 				= trim($comingsoon_date[2]);
...
jQuery(function($) {
  $('#sp-comingsoon-countdown').countdown('".$year."/".$month."/".$day."', function(event) {
    $(this).html(event.strftime('<div class=\"days\"><span class=\"number\">%-D</span><span class=\"string\">%!D:".Text::_('HELIX_DAY').",".Text::_('HELIX_DAYS').";</span></div><div class=\"hours\"><span class=\"number\">%H</span><span class=\"string\">%!H:".Text::_('HELIX_HOUR').",".Text::_('HELIX_HOURS').";</span></div><div class=\"minutes\"><span class=\"number\">%M</span><span class=\"string\">%!M:".Text::_('HELIX_MINUTE').",".Text::_('HELIX_MINUTES').";</span></div><div class=\"seconds\"><span class=\"number\">%S</span><span class=\"string\">%!S:".Text::_('HELIX_SECOND').",".Text::_('HELIX_SECONDS').";</span></div>'));
  });
});
");
?>
...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, all.min.css, font-awesome-v4-shims.min.css')
			...
			<div class="text-center">
				<div id="sp-comingsoon">
					...
					<ul class="social-icons">
						...
						<?php if ($whatsapp) : ?>
							<li><a href="whatsapp://send?abid=<?php echo $whatsapp; ?>&text=Hi" aria-label="whatsapp"><i class="fa fa-whatsapp"></i></a></li>
						<?php endif; ?>
						
						<?php if ($instagram) : ?>
							<li><a target="_blank" href="//www.instagram.com/<?php echo $instagram; ?>" aria-label="instagram"><i class="fa fa-instagram"></i></a></li>
						<?php endif; ?>
						
						<?php if ($tiktok) : ?>
							<li><a target="_blank" href="//tiktok.com/@<?php echo $tiktok; ?>" aria-label="tiktok"><i class="fa fa-tiktok"></i></a></li>
						<?php endif; ?>
						
						<?php if ($telegram) : ?>
							<li><a target="_blank" href="//t.me/<?php echo $telegram; ?>" aria-label="telegram"><i class="fab fa-telegram-plane"></i></a></li>
						<?php endif; ?>
					<ul>
					<?php endif; ?>
				</div>
